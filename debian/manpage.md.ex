% gz-fuel-tools(SECTION) | User Commands
%
% "March  8 2023"
...
gz-fuel-tools - program to do something

# SYNOPSIS

**gz-fuel-tools** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**gz-fuel-tools** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **gz-fuel-tools** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**gz-fuel-tools** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    gz-fuel-tools. See **foo.conf**(5) for further details.
...
**gz-fuel-tools** provides some return codes, that can be used in scripts:
